"""Generator — writes dataset_metadata_audit.py to disk."""
import pathlib

TARGET = pathlib.Path(r"D:\SIH\IceBerg\scripts\dataset_metadata_audit.py")
...
print(f"Written: {TARGET.stat().st_size:,} bytes  ({TARGET.stat().st_size//1024} KB)")
